...
<footer className="foot" id="foot">
  <div className="wrap">
    <div className="foot-grid">
      <div>
        <a href="#" className="brand"><span className="name">Valyusha</span><span className="sub">Гід в Японії</span></a>
        <p style={{ color: 'rgba(255,255,255,.7)', fontSize: '15px', marginTop: '16px', maxWidth: '34ch' }}>Авторські екскурсії та індивідуальні тури Японією з ліцензованим україномовним гідом.</p>
      </div>
      <div>
      ...
      <div className="foot-cta">
        <span className="foot-tagline">Японія чекає на вас!</span>
        <a href="https://wa.me/818033605724" className="btn btn-rose"><svg className="ico" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 0 0-8.6 15l-1.4 5 5.1-1.3A10 10 0 1 0 12 2z"/></svg>Написати в WhatsApp</a>
      </div>
    </div>
    <div className="foot-bot">
      <span>© 2026 Valyusha · Гід в Японії</span>
